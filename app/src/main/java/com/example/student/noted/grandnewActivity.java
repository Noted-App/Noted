...
public class grandnewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void seekbarr() {
        ...
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                ...
                Toast.makeText(grandnewActivity.this, "Tempo Change", Toast.LENGTH_LONG).show();
